...
export default function Footer() {
  return (
    <footer className="footer footer-center p-10 bg-[--bg-li]">
    <div className="font-bold text-[--bg-intro-text] text-lg">
      <h1 className='font-luckiest text-[3rem] p-4'>GenzShop&apos;s</h1>
      <p>
       Approved by GenZ since 2023
      </p>
