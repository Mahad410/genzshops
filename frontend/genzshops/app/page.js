        ...
        <section className="h-screen bg-[--bg-intro] w-full">
          <div className="min-h-screen relative">
            ...
            <div className="m-[auto] text-sm xl:text-xl font-semibold xl:font-bold leading-loose absolute  bottom-[17%] md:bottom-[18%] left-[50%] translate-x-[-50%] h-min w-[85%] md:w-[70%] lg:w-[80%]">
              <p>
                Genz Shops brings you the latest and coolest products in an eCommerce store with the most remarkable UI and color scheme! Experience the thrill of shopping as our modern interface indulges your eyes and your wallet.
              </p>
              <div>
                <Link href={'/products'}>
                  <button className="btn bg-[#ffffff] hover:bg-[--bg-li] border-[4px] border-[#000000] hover:border-[#ffffff] rounded-full font-bold text-[#000000] hover:text-[--sidebar-text] mt-[30px] h-min">
                  Shop Now
                </button>
                </Link>
              </div>
